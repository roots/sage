...
2. Hero (to control its visibility use the theme customizer)
2. Left Footer (used by `templates/footer.php`)
3. Center Footer (used by `templates/footer.php`)
4. Right Footer (used by `templates/footer.php`)
