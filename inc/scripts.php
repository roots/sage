...
function roots_scripts() {
  ...
  if (current_theme_supports('bootstrap-responsive')) wp_enqueue_style('roots_bootstrap_responsive_style', '/css/bootstrap-responsive.css', array('roots_bootstrap_style'), null);
  ...
  if (is_child_theme()) wp_enqueue_style('roots_child_style', get_stylesheet_uri());
