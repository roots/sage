...
function roots_scripts() {
  wp_enqueue_style('atkore_bootstrap', get_stylesheet_directory_uri() . '/assets/css/bootstrap.css', false, null);
  wp_enqueue_style('atkore_bootstrap_responsive', get_stylesheet_directory_uri() . '/assets/css/responsive.css', array('roots_bootstrap'), null);
  wp_enqueue_style('roots_app', get_template_directory_uri() . '/assets/css/app.css', false, null);
  //wp_enqueue_style('atkore_less', get_stylesheet_directory_uri() . '/assets/css/atkore.css', false, null);
  ...
  wp_register_script('sequence', get_stylesheet_directory_uri() . '/assets/js/vendor/sequence.jquery-min.js', false, '0.8.5-beta', true);
