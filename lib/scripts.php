 ...
 * 2. /theme/assets/vendor/modernizr/modernizr.js
...
function roots_scripts() {
  ...
  wp_register_script('modernizr', get_template_directory_uri() . '/assets/vendor/modernizr/modernizr.js', array(), null, false);
