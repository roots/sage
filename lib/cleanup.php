 ...
 */
function shoestrap_search_query($escaped = true) {
  $query = apply_filters('shoestrap_search_query', get_query_var('s'));
...
add_filter('get_search_query', 'shoestrap_search_query');
