...
jQuery.noConflict();
    ...
    jQuery(document).ready(function($){
		...
		function GoogleFontSelectHybrid( mainID, selector ){
			...
			if (google && $(selector).hasClass('of-typography-new-face')) {
			...
			$('#'+mainID+' .typography-style span').text($('#'+mainID+' .of-typography-style option:selected').text());
			$('#'+mainID+' .typography-script span').text($('#'+mainID+' .of-typography-script option:selected').text());
