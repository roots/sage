...
require_once locate_template( SMOF_DIR . 'addons/functions/functions.admin.php'); 
require_once locate_template( SMOF_DIR . 'addons/functions/functions.options.php'); 
require_once locate_template( SMOF_DIR . 'addons/functions/functions.interface.php'); 
require_once locate_template( SMOF_DIR . 'addons/functions/functions.customizer.php'); 
require_once locate_template( SMOF_DIR . 'addons/functions/functions.customizer.standard.php'); 
