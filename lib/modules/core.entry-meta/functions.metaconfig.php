...
if ( !function_exists( 'shoestrap_entry_meta_custom_check' ) ) :

function shoestrap_entry_meta_custom_check() {
 
  //$entry_meta_config     = shoestrap_getVariable( 'shoestrap_entry_meta_config' );
...
add_action('init','shoestrap_entry_meta_custom_check',20);
