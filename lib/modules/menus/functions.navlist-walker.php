 ...
 */
function shoestrap_nav_menu_css_class_alter($classes, $item) {
...
add_filter('nav_menu_css_class', 'shoestrap_nav_menu_css_class_alter', 10, 2);
...
add_filter('wp_nav_menu_args', 'shoestrap_nav_menu_args_alter');
