  ...
  <div class="row">
   <div class="visible-xs hidden-sm hidden-md hidden-lg row">
      <div class="visible-xs hidden-sm hidden-md hidden-lg col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <a href="<?php echo home_url(); ?>/" class="visible-xs hidden-sm hidden-md hidden-lg"><div class="brand-logo"><img alt="<?php get_bloginfo('name'); ?>" class="img-responsive" src="<?php the_field('color_logo_horizontal', 'options'); ?>" ></div></a>
      </div>
   </div>
